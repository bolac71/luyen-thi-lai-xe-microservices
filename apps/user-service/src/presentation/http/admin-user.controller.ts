...
export class AdminUserController {
  ...
  @Get()
  @Roles({ roles: ['realm:ADMIN', 'realm:CENTER_MANAGER'] })
  @ApiOperation({ summary: 'List user profiles for admin dashboard' })
  async listUsers(
  ...
  @Get(':id')
  @Roles({ roles: ['realm:ADMIN', 'realm:CENTER_MANAGER'] })
  @ApiOperation({ summary: 'Get user profile by ID for admin dashboard' })
  ...
  @ApiOperation({ summary: 'Lock or unlock a user profile' })
  async lockUser(
    @Param('id') id: string,
